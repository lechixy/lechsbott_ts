...
//         let acceptEmbed = new Discord.Embed()
...
//         let accept = new Discord.ButtonComponent()
//             .setLabel('Accept')
//             .setStyle('SUCCESS')
//             .setCustomId('acceptedRequest')

//         let decline = new Discord.ButtonComponent()
//             .setLabel('Decline')
//             .setStyle('DANGER')
//             .setCustomId('declinedRequest')

//         let accep = new Discord.ActionRow().addComponents([
//             accept,
//             decline
//         ])
...
//                     .setColor(Discord.Util.resolveColor('Random'))
//                     .setAuthor({name: this.host.tag, iconURL: this.host.displayAvatarURL()})
